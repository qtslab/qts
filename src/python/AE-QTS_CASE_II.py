...
# Real valued weights
#items=np.mod(range(0,n_items-1),10)+1
...
print(f'CASE II: {n_items} items, {expTime} experiments, {rTime} times rotation')
...
case I:
    QTS
        100-381.86 (381.86-230.77)/381.86 = 0.39566856963
        250-720.02 (720.02-590.76)/720.02 = 0.17952279103
        500-905.14 (905.14-765.02)/905.14 = 0.15480478158
    AE-QTS
        100-230.77 (0.39566856963+0.28430445902+0.32742305486)/3 = 0.3357986945
        250-590.76 (0.17952279103+0.31393809814+0.32982378854)/3 = 0.2744282259
        500-765.02 (0.15480478158+0.14326861419+0.29787382460)/3 = 0.19864907345
case II
    QTS
        100-359.72 (359.72-257.45)/359.72 = 0.28430445902
        250-785.76 (785.76-539.08)/785.76 = 0.31393809814
        500-951.29 (951.29-815.00)/951.29 = 0.14326861419
    AE-QTS
        100-257.45
        250-539.08
        500-815.00
...
case III
    QTS
        100-209.24 (209.24-140.73)/209.24 = 0.32742305486
        250-454.00 (454.00-304.26)/454.00 = 0.32982378854
        500-716.78 (716.78-503.27)/716.78 = 0.29787382460
    AE-QTS
        100-140.73
        250-304.26
        500-503.27
